...
export default {
  ...
  openDB: function (dbname, version, db, newStore, callback) {
    ...
    var request = this.indexedDB.open(dbname, currentVersion)
  ...
  handleDataByCursor: function (db, storename, callback, aKeyRange) {
    var keyRange = aKeyRange || ''
    var store = db.transaction(storename, 'readwrite').objectStore(storename)
    var request
  ...
  handleDataByIndex: function (db, storename, cursorIndex, callback, aKeyRange) {
    var keyRange = aKeyRange || ''
    var store = db.transaction(storename, 'readwrite').objectStore(storename)
    var request
