    ...
    <div class="steps clear">
      ...
      <div class="location clear">
        <div class="step">
          ...
          <div class="title"> new orders  <div  class="badge"> <sup> {{itemCounts.pending}} </sup> </div>
            <div>
        ...
        <div class="step">
          <div class="linex "> </div>
          <div class="title"> ready for factory  <div  class="badge"> <sup> {{itemCounts.ready_for_factory}} </sup> </div>
            <div>
              <el-button @click="processItems('ready_for_factory')" size="small">Item</el-button>
              <el-button @click="handleScanOrders('ready_for_factory')" size="small">Scan</el-button>
            </div>
          </div>
        </div>
        <div class="step" style="float:right;">
          <div class="linex offset-l50" style=""> </div>
          <div class="title"> ready  <div  class="badge"> <sup> {{itemCounts.ready}} </sup> </div>
            <div>
      ...
      <div class="location clear">
        ...
        <div class="step" style="width:100%;">
          <div class="linex offset-r50"> </div>
          <div class="title"> ready_for_store  <div  class="badge"> <sup> {{itemCounts.ready_for_store}} </sup> </div>
            <div>
