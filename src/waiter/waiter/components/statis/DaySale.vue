...
<div class="fillcontain">
  <section class="data_section">
    ...
    <el-row :gutter="20" style="margin-bottom: 10px;">
      ...
      <el-col :span="4">
        <div class="data_list"><span class="data_num">{{userCount}}</span> 新增客户</div>
      </el-col>
      <el-col :span="4">
        <div class="data_list"><span class="data_num">{{orderCount}}</span> 新增订单</div>
      </el-col>
      <el-col :span="4">
        <div class="data_list"><span class="data_num">{{cardCount}}</span> 新增会员卡</div>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="4">
      ...
      <el-col :span="4">
        <div class="data_list"><span class="data_num">{{allUserCount}}</span> 注册客户</div>
      </el-col>
      <el-col :span="4">
        <div class="data_list"><span class="data_num">{{allOrderCount}}</span> 订单</div>
      </el-col>
      <el-col :span="4">
        <div class="data_list"><span class="data_num">{{allCardCount}}</span> 会员卡</div>
      </el-col>
    </el-row>
  </section>
