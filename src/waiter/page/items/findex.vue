...
<template>
  ...
  <div>
    ...
    <div class="factory-item-flow-container page-content">
      ...
      <item-process :selected-store-id="formData.storeId" :order-state="currentOrderState" :dialog-visible.sync="processItemDialogVisible" @order-state-changed="orderStateChanged" caller="factory"> </item-process>
